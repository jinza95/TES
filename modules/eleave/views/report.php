...
class View extends \Gcms\View
{
    ...
    public function render(Request $request, $params, $login)
    {
        ...
        $table = new DataTable([
            ...
            'hideColumns' => ['id', 'start_period', 'end_date', 'end_period', 'member_id'],
            ...
            'filters' => [
                ...
                [
                    'name' => 'leave_id',
                    'options' => [0 => '{LNG_all items}'] + $this->leavetype->toSelect(),
                    'text' => '{LNG_Leave type}',
            ...
            'buttons' => [
                'statistics' => [
                    ...
                    'href' => $uri->createBackUri(['module' => 'eleave-statistics', 'id' => ':member_id', 'start_date' => ':start_date']),
                ...
                'edit' => [
                    ...
                    'href' => $uri->createBackUri(['module' => 'eleave-approve', 'id' => ':id']),
                    'text' => '{LNG_Approve}'
                ]
            ]
        ]);
